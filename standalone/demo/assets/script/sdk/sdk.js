    ...
    sdk.prototype.wechatLogin = function(callback) {
        ...
        if (cc.sys.platform === cc.sys.WECHAT_GAME) {
            ...
            if(user){
                ...
                self.createImage(sp, self.sdk_conf.loginButton.loginBg);
                ...
                if(self.button){
                    ...
                    wx.getSystemInfo({
                        success(res){
                            var width = self.sdk_conf.loginButton.loginBtWidth/2;
                            var height = self.sdk_conf.loginButton.loginBtHeight/2;
                            self.button = wx.createUserInfoButton({
                                type: 'image',
                                image: self.sdk_conf.loginButton.loginBt,
